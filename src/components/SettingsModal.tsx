            ...
            {activeTab === "secrets" && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-sura-text-sec/60 mt-0.5">
                    By default, Sura AI runs on our shared global free-tier developer keys. To guarantee unlimited cloud reasoning capacity, you can input your own custom key below.
                  </p>
                </div>
